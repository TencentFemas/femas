...
public class InvalidResourceException extends RuntimeException {
    ...
    public InvalidResourceException(String errorCode) {
        this(errorCode, (String) null);
    }

    public InvalidResourceException(String errorCode, String errorMessage) {
        this(errorCode, errorMessage, (Throwable) null);
    }

    public InvalidResourceException(String errorCode, Throwable cause) {
        this(errorCode, (String) null, cause);
    }

    public InvalidResourceException(String errorCode, String errorMessage, Throwable cause) {
