 ...
 */
public class FemasKubernetesDiscoveryClient implements DiscoveryClient {

    private static final Log log = LogFactory.getLog(FemasKubernetesDiscoveryClient.class);
    public static final String NAMESPACE_METADATA_KEY = "k8s_namespace";
    private static final String FEMAS_META_K8S_KEY = "femas-service-metadata";

    private static final String FEMAS_K8S_SELECT_LABEL_KEY = "femas-service-app=";
    ...
    public FemasKubernetesDiscoveryClient(KubernetesClient client,
    ...
    public FemasKubernetesDiscoveryClient(KubernetesClient client, KubernetesDiscoveryProperties kubernetesDiscoveryProperties,
                                          KubernetesClientServicesFunction kubernetesClientServicesFunction,
