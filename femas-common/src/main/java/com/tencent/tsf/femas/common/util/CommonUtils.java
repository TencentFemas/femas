...
public class CommonUtils {
    ...
    public static <T> T checkNotNull(String key, T value) {
        if (value == null) {
            throw new IllegalArgumentException("Consul Config KEY " + key + " cannot be null.");
        }

        if (value instanceof String && ((String) value).isEmpty()) {
            throw new IllegalArgumentException("Consul Config KEY " + key + " cannot be empty.");
        }
