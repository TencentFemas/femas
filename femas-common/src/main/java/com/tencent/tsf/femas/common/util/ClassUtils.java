...
import static com.tencent.tsf.femas.common.util.ClassLoaderUtils.getCurrentClassLoader;
...
public final class ClassUtils {
     ...
     * @param <T> 对象具体类
     * @return 对象实例
     * @throws FemasRuntimeException 没有找到方法，或者无法处理，或者初始化方法异常等
     */
    public static <T> T newInstance(Class<T> clazz) throws FemasRuntimeException {
        ...
        try {
            ...
            if (constructors == null || constructors.length == 0) {
                throw new FemasRuntimeException("The " + clazz.getCanonicalName()
