 ...
 */
package com.tencent.tsf.femas.registry.nacos;
...
import com.tencent.tsf.femas.registry.impl.nacos.discovery.NacosServiceDiscoveryClient;
import com.tencent.tsf.femas.registry.impl.nacos.serviceregistry.NacosServiceRegistry;
...
public class NacosRegistryTest {
    ...
    private AbstractServiceDiscoveryClient getDiscoveryClient() {
        return new NacosServiceDiscoveryClient(configMap);
    }
    ...
    public void init() {
        ...
        configMap.put(RegistryConstants.REGISTRY_PORT, "8848");
