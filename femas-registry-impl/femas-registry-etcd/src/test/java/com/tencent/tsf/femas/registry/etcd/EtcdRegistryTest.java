 ...
 */
package com.tencent.tsf.femas.registry.etcd;
...
import com.tencent.tsf.femas.registry.impl.etcd.discovery.EtcdServiceDiscoveryClient;
import com.tencent.tsf.femas.registry.impl.etcd.serviceregistry.EtcdServiceRegistry;
...
public class EtcdRegistryTest {
    ...
    public void init() {
        ...
        configMap.put(RegistryConstants.REGISTRY_HOST, "http://127.0.0.1");
        configMap.put(RegistryConstants.REGISTRY_PORT, "2379");
